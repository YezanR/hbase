...
typedef enum
{
	...
	DISABLE, DISABLE_ALL, DROP, DROP_ALL, ENABLE, ENABLE_ALL, STATUS, SCAN, COUNT, GET, PUT, DELETE, DELETE_ALL, _HELP, ALTER_STATUS, WHOAMI, SIMPLE,
	VERSION, IS_ENABLED, IS_DISABLED, _LIST, SHOW_FILTERS, EOC, NAME, VERSIONS, FILTER, METHOD, BEG_IN, EXIT, EXISTS, TOOLS, SHUTDOWN, TRUNCATE, MAX_FILESIZE, UNKNOWN_TOKEN
}typetoken;
